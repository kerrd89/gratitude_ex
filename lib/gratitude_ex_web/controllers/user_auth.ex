defmodule GratitudeExWeb.UserAuth do
  @moduledoc """
  Helper functions related to userauth functions
  """
  import Plug.Conn
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_gratitude_ex_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GratitudeExWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(_conn, _user), do: ~p"/jars"
end
